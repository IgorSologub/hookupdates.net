...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='GV0w2']");
    private final By headerMenuOpen = By.xpath("//button[@class='LMMykfQs3Hr js-modal-btn']");
    private final By languageMenuOpen = By.xpath("(//a[@class='EFVpH PjetVWz js-header-drop-btn '])[5]");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='EFVpH '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='EFVpH '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='vtLiYoof'])[" + numButton + "]");
